...
export const BADGES = {
  FIRST_STEPS: { id: "first_steps", name: "First Steps", description: "Added your first transaction", icon: "🌱", image: "/assets/badges/first_steps.png" },
  BUDGET_NINJA: { id: "budget_ninja", name: "Budget Ninja", description: "Stayed under budget for a month", icon: "🥷", image: "/assets/badges/budget_ninja.png" },
  WEEK_WARRIOR: { id: "week_warrior", name: "Week Warrior", description: "7-day streak", icon: "🔥", image: "/assets/badges/week_warrior.png" },
  MONTH_MASTER: { id: "month_master", name: "Month Master", description: "30-day streak", icon: "👑", image: "/assets/badges/month_master.png" },
  SAVER_PRO: { id: "saver_pro", name: "Saver Pro", description: "Saved 20% of income", icon: "💰", image: "/assets/badges/saver_pro.png" },
  TRACKER_ELITE: { id: "tracker_elite", name: "Tracker Elite", description: "100 transactions logged", icon: "📝", image: "/assets/badges/tracker_elite.png" },
  NO_SPEND_DAY: { id: "no_spend_day", name: "No Spend Day", description: "Logged 0 expenses for a day", icon: "🛑", image: "/assets/badges/no_spend_day.png" },
  NO_SPEND_WEEK: { id: "no_spend_week", name: "No Spend Week", description: "7 days without expenses", icon: "🛡️", image: "/assets/badges/no_spend_week.png" },
  BUDGET_BEGINNER: { id: "budget_beginner", name: "Budget Beginner", description: "Stayed within budget for 1 month", icon: "🥉", image: "/assets/badges/budget_beginner.png" },
  BUDGET_PRO: { id: "budget_pro", name: "Budget Pro", description: "Stayed within budget for 3 months", icon: "🥈", image: "/assets/badges/budget_pro.png" },
  BUDGET_CHAMPION: { id: "budget_champion", name: "Budget Champion", description: "Stayed within budget for 6 months", icon: "🥇", image: "/assets/badges/budget_champion.png" },
  YEAR_OF_DISCIPLINE: { id: "year_of_discipline", name: "Year of Discipline", description: "Stayed within budget for 12 months", icon: "💎", image: "/assets/badges/year_of_discipline.png" },
  INCOME_LOGGER: { id: "income_logger", name: "Income Logger", description: "Added income 10 times", icon: "📈", image: "/assets/badges/income_logger.png" },
  INCOME_STREAMER: { id: "income_streamer", name: "Income Streamer", description: "Added 3+ different income sources", icon: "🌊", image: "/assets/badges/income_streamer.png" },
  SALARY_MASTER: { id: "salary_master", name: "Salary Master", description: "First salary added", icon: "💼", image: "/assets/badges/salary_master.png" },
  SIDE_HUSTLER: { id: "side_hustler", name: "Side Hustler", description: "Earned income from freelancing", icon: "💻", image: "/assets/badges/side_hustler.png" },
  LEVEL_UP_EARNER: { id: "level_up_earner", name: "Level Up Earner", description: "Income increased for 3 consecutive months", icon: "🚀", image: "/assets/badges/level_up_earner.png" },

  // Expense Entry Milestones
  LOG_10: { id: "log_10", name: "Getting Started", description: "Logged 10 transactions", icon: "📝", image: "/assets/badges/log_10.png" },
  LOG_50: { id: "log_50", name: "Consistent Tracker", description: "Logged 50 transactions", icon: "📊", image: "/assets/badges/log_50.png" },
  // TRACKER_ELITE is 100 logs
  LOG_500: { id: "log_500", name: "Data Hoarder", description: "Logged 500 transactions", icon: "📚", image: "/assets/badges/log_500.png" },
  FINANCE_GURU: { id: "finance_guru", name: "Finance Guru", description: "Logged 1000 transactions", icon: "🧘", image: "/assets/badges/finance_guru.png" },

  // Net Worth Milestones
  POSITIVE_NET_WORTH: { id: "positive_net_worth", name: "In The Green", description: "Achieved positive net worth", icon: "💹", image: "/assets/badges/positive_net_worth.png" },
  UPWARD_GROWTH: { id: "upward_growth", name: "Upward Growth", description: "Net worth increased for 3 consecutive months", icon: "📈", image: "/assets/badges/upward_growth.png" },

  // Daily Logging Badges
  DAILY_STARTER: { id: "daily_starter", name: "Daily Starter", description: "Completed daily tasks 1 day", icon: "🌅", image: "/assets/badges/daily_starter.png" },
  DAILY_DUO: { id: "daily_duo", name: "Daily Duo", description: "Completed daily tasks 2 days in a row", icon: "👯", image: "/assets/badges/daily_duo.png" },
  DAILY_STREAK_3: { id: "daily_streak_3", name: "Daily Streak 3", description: "3-day daily task streak", icon: "🔥", image: "/assets/badges/daily_streak_3.png" },
  DAILY_STREAK_7: { id: "daily_streak_7", name: "Daily Streak 7", description: "1 week daily task streak", icon: "📅", image: "/assets/badges/daily_streak_7.png" },
  DAILY_STREAK_14: { id: "daily_streak_14", name: "Daily Streak 14", description: "2 weeks daily task streak", icon: "🗓️", image: "/assets/badges/daily_streak_14.png" },
  DAILY_STREAK_30: { id: "daily_streak_30", name: "Daily Streak 30", description: "1 month daily task streak", icon: "🌙", image: "/assets/badges/daily_streak_30.png" },
  DAILY_STREAK_50: { id: "daily_streak_50", name: "Daily Streak 50", description: "50 days daily task streak", icon: "🌟", image: "/assets/badges/daily_streak_50.png" },
  DAILY_STREAK_100: { id: "daily_streak_100", name: "Daily Streak 100", description: "100 days daily task streak", icon: "💯", image: "/assets/badges/daily_streak_100.png" },
  DAILY_MACHINE: { id: "daily_machine", name: "Daily Machine", description: "150 days daily task streak", icon: "🤖", image: "/assets/badges/daily_machine.png" },
  DAILY_LEGEND: { id: "daily_legend", name: "Daily Legend", description: "365 days daily task streak", icon: "👑", image: "/assets/badges/daily_legend.png" },

  // Weekly Logging Badges
  WEEKLY_STARTER: { id: "weekly_starter", name: "Weekly Starter", description: "Completed weekly tasks 1 week", icon: "🌱", image: "/assets/badges/weekly_starter.png" },
  WEEKLY_CONSISTENT: { id: "weekly_consistent", name: "Weekly Consistent", description: "Completed weekly tasks 2 weeks in a row", icon: "🌿", image: "/assets/badges/weekly_consistent.png" },
  WEEKLY_STREAK_4: { id: "weekly_streak_4", name: "Weekly Warrior", description: "4 weeks weekly task streak", icon: "⚔️", image: "/assets/badges/weekly_streak_4.png" },
  WEEKLY_STREAK_8: { id: "weekly_streak_8", name: "Weekly Master", description: "8 weeks weekly task streak", icon: "🛡️", image: "/assets/badges/weekly_streak_8.png" },
  WEEKLY_DOMINATOR: { id: "weekly_dominator", name: "Weekly Dominator", description: "12 weeks weekly task streak", icon: "🏰", image: "/assets/badges/weekly_dominator.png" },
  WEEKLY_CHAMPION: { id: "weekly_champion", name: "Weekly Champion", description: "26 weeks weekly task streak", icon: "🏆", image: "/assets/badges/weekly_champion.png" },
  WEEKLY_ACE: { id: "weekly_ace", name: "Weekly Ace", description: "52 weeks weekly task streak", icon: "👑", image: "/assets/badges/weekly_ace.png" },

  // Monthly Logging Badges
  MONTHLY_TASK_STREAK_1: { id: "monthly_task_streak_1", name: "Monthly Beginner", description: "Completed monthly tasks 1 month", icon: "🥉", image: "/assets/badges/monthly_task_streak_1.png" },
  MONTHLY_TASK_STREAK_2: { id: "monthly_task_streak_2", name: "MonthlyBuilder", description: "Completed monthly tasks 2 months in a row", icon: "🔨", image: "/assets/badges/monthly_task_streak_2.png" },
  MONTHLY_TASK_STREAK_3: { id: "monthly_task_streak_3", name: "Monthly Consistent", description: "Completed monthly tasks 3 months in a row", icon: "📅", image: "/assets/badges/monthly_task_streak_3.png" },
  MONTHLY_TASK_STREAK_6: { id: "monthly_task_streak_6", name: "Monthly Hero", description: "Completed monthly tasks 6 months in a row", icon: "🦸", image: "/assets/badges/monthly_task_streak_6.png" },
  MONTHLY_TASK_STREAK_12: { id: "monthly_task_streak_12", name: "Monthly Champion", description: "Completed monthly tasks 12 months in a row", icon: "🏆", image: "/assets/badges/monthly_task_streak_12.png" },
  MONTHLY_TASK_STREAK_18: { id: "monthly_task_streak_18", name: "Monthly Veteran", description: "Completed monthly tasks 18 months in a row", icon: "🎖️", image: "/assets/badges/monthly_task_streak_18.png" },
  MONTHLY_TASK_STREAK_24: { id: "monthly_task_streak_24", name: "Monthly Master", description: "Completed monthly tasks 24 months in a row", icon: "👑", image: "/assets/badges/monthly_task_streak_24.png" },
  MONTHLY_TASK_STREAK_36: { id: "monthly_task_streak_36", name: "Monthly Legend", description: "Completed monthly tasks 36 months in a row", icon: "💎", image: "/assets/badges/monthly_task_streak_36.png" },

  // Legacy/Imported Badges (to support existing user data)
  FIRST_TRANSACTION: { id: "first_transaction", name: "First Transaction", description: "Added your first transaction", icon: "🌱", image: "/assets/badges/first_transaction.png" },
  BUDGET_MASTER: { id: "budget_master", name: "Budget Master", description: "Mastered your budget", icon: "🎯", image: "/assets/badges/budget_master.png" },
  SAVINGS_STARTER: { id: "savings_starter", name: "Savings Starter", description: "Started your savings journey", icon: "🐷", image: "/assets/badges/savings_starter.png" },
  WEALTH_BUILDER: { id: "wealth_builder", name: "Wealth Builder", description: "Growing your net worth", icon: "💼", image: "/assets/badges/wealth_builder.png" },
};
