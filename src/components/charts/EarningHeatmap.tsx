...
export function EarningHeatmap() {
    ...
    const getColor = (intensity: number) => {
        ...
        // Monochromatic Green Scale for Earnings (Higher is better/darker green)
        if (intensity < 0.25) return "hsl(142 76% 36% / 0.3)";
        if (intensity < 0.5) return "hsl(142 76% 36% / 0.5)";
        if (intensity < 0.75) return "hsl(142 76% 36% / 0.7)";
        return "hsl(142 76% 36% / 0.9)";
    };

    return (
        <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-base font-medium">Earning Heatmap</CardTitle>
            ...
            <CardContent>
                ...
                <div className="mt-4 flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <div className="flex gap-1">
                        ...
                        <div className="w-4 h-4 rounded" style={{ backgroundColor: "hsl(142 76% 36% / 0.7)" }} />
                        <div className="w-4 h-4 rounded" style={{ backgroundColor: "hsl(142 76% 36% / 0.9)" }} />
                    </div>
                    <span>More</span>
                </div>
            </CardContent>
